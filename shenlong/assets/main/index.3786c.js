    ...
    MainGameJS: [function(e, t) {
        ...
        e("../MainManage").endHttpShowInfo, cc.Class({
            ...
            onLoad: function() {/////游戏初始化
                ...
                this.platFromNum = 1, this.judgeCurPlatform(), 
                this.adapterScreen(), this.gameOveEndBool = !1, 
                this.gameOverNum = 0, this.gameWidth = cc.winSize.width, 
                this.gameHeight = cc.winSize.height, a.curType = this.returnCurrentLanType(), 
                a.playNum >= 1 && (this.startBgNode.active = !1), a.playNum++, 
                ...
                this.Hscale >= this.Wscale ? this.SizeScale = this.Wscale : this.SizeScale = this.Hscale,
                 ...
                 this.speed = this.speedNum, this.BGNum = 9, this.kedouArr = [], this.qingwaArr = [], this.haiguiArr = [], 
